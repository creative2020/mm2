...
<!--Single-->
    <?php if ( is_single() ) { ?>
        ...
        <div class="row">
    <div id="page-header" style="background-color:<?php echo $bg_color; ?>;" class="col-sm-12">
        <h1 class="page-title"><i class="fa fa-<?php echo $tt_icon; ?>" style="color:<?php echo $font_color; ?>;font-size:<?php echo $icon_size; ?>"></i> <?php the_title(); ?></h1>
    </div>
</div> <!--row-->
